...
int main() {
    ...
    // Teste 1:
    // Equipamentos:
    // { {"lampada", 0.5}, {"ar-condicionado", 2.0}, {"geladeira", 1.5} }
    // Percentual: 10.0%
    // Cálculo:
    // "lampada": 0.5 * 1.10 = 0.55
    // "ar-condicionado": 2.0 * 1.10 = 2.20
    // "geladeira": 1.5 * 1.10 = 1.65
    // Total esperado = 0.55 + 2.20 + 1.65 = 4.40
    ...
    // Teste 2:
    // Equipamentos:
    // { {"tv", 1.0}, {"computador", 3.0} }
    // Percentual: 0.0% (sem alteração)
    // Total esperado = 1.0 + 3.0 = 4.0
    ...
    // Teste 3:
    // Equipamentos vazios e percentual qualquer.
    equipamentos = {};
    percentual = 5.0;
    esperadoTotal = 0.0;
    obtidoTotal = atualizarTarifasPorInflacao(equipamentos, percentual);
